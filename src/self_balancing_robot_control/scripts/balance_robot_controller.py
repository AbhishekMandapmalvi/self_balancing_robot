...
class BalanceRobotController:
    ...
    def sensor_callback(self, msg):
        ...
        rospy.loginfo("Euler angles (roll, pitch, yaw), Encoder(left_vel, right_vel, left_dist, right_dist): %.2f, %.2f, %.2f, %.2f, %.2f, %.2f, %.2f", 
                     euler[0], euler[1], euler[2], left_vel, right_vel, left_dist, right_dist)
