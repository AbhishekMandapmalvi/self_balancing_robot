...
// Encoder Pins
static const int ENCODER_LEFT_A_PIN = 18; //18
static const int ENCODER_LEFT_B_PIN = 19; //19
static const int ENCODER_RIGHT_A_PIN = 3; //3
static const int ENCODER_RIGHT_B_PIN = 2; //2
